...
- Readable HTML board: [pattern-layer-section-featured-discovery.html](pattern-layer-section-featured-discovery.html)
- Read-only raw matrix: [pattern-layer-section-featured-discovery-matrix.md](pattern-layer-section-featured-discovery-matrix.md)
